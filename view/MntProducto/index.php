...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>CONTACTOS<span>]</span></a></div>
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="../MntProducto/" class="nav-link">CONTACTOS</a></li>
        </ul>
      </div>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Contactos</h4>
        <p class="mg-b-0">Desde esta ventana podra dar mantenimiento a contactos</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Mantenimiento de Contactos</h6>
              ...
              <table id="producto_data" class="table display responsive nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-15p">Puesto de trabajo</th>
                    <th class="wd-15p">Pais de procedencia</th>
                    <th class="wd-15p"></th>
                    <th class="wd-20p"></th>
                  </tr>
                </thead>
